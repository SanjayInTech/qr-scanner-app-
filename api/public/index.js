...
const API_BASE_URL = "https://192.168.145.23:3000"; // Change if the IP updates
...
// 🔹 QR Code Scan Success Handler
    function onScanSuccess(decodedText) {
        ...
        const scanTimestamp = istDate.toISOString().split("Z")[0].slice(0, 16);
        document.getElementById("result").innerHTML = `Scanned QR Code: ${decodedText}`;
        console.log(`QR Code scanned: ${decodedText}, Timestamp (IST): ${scanTimestamp}`);
